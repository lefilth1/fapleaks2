...
function show404(msg = 'Not Found') {
  document.getElementById('main-content').innerHTML = `
    <div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      ...
      <a href="${BASE_PATH}/" class="btn-primary px-8 py-3 rounded-2xl font-bold text-white">← Back Home</a>
    </div>`;
}
...
function relatedCardHTML(v) {
  ...
  <article class="related-card group" data-id="${v.id}">
    <a href="${BASE_PATH}/video/${v.slug}" class="related-thumb">
    ...
    <div class="related-body">
      <a href="${BASE_PATH}/video/${v.slug}"><h4 class="related-title">${esc(v.title)}</h4></a>
